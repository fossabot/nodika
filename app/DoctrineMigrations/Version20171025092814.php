 ...
 */
class Version20171025092814 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE user_event_log (id INTEGER NOT NULL, person_id INTEGER DEFAULT NULL, "key" CLOB NOT NULL, value CLOB NOT NULL, occurred_at_date_time DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_9E1020F2217BBB47 ON user_event_log (person_id)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP TABLE user_event_log');
        $this->addSql('DROP INDEX IDX_D83AEDDD9E6B1585');
