 ...
 */
class Version20171101190719 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE person ADD COLUMN study_group INTEGER DEFAULT NULL');
        ...
        $this->addSql('DROP INDEX IDX_9E1020F2217BBB47');
        $this->addSql('CREATE TEMPORARY TABLE __temp__user_event_log AS SELECT id, person_id, "key", value, occurred_at_date_time, deleted_at FROM user_event_log');
        $this->addSql('DROP TABLE user_event_log');
        $this->addSql('CREATE TABLE user_event_log (id INTEGER NOT NULL, person_id INTEGER DEFAULT NULL, "key" CLOB NOT NULL COLLATE BINARY, value CLOB NOT NULL COLLATE BINARY, occurred_at_date_time DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, PRIMARY KEY(id), CONSTRAINT FK_9E1020F2217BBB47 FOREIGN KEY (person_id) REFERENCES person (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO user_event_log (id, person_id, "key", value, occurred_at_date_time, deleted_at) SELECT id, person_id, "key", value, occurred_at_date_time, deleted_at FROM __temp__user_event_log');
        $this->addSql('DROP TABLE __temp__user_event_log');
